...
module.exports = (isShortcut, lint, errors) => through.obj(function(file, _, next) {
    var tree = file.tree;
    ...
    debugger;
    module.exports.rule({blockNameShortcut: isShortcut, errors: lint ? errors : null})(tree);
